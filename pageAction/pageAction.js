...
function getCurrentActiveTab(tabs) {
    ...
    function handleResponse(res) {
        ...
        if (res.atom) {
            document.getElementById("atom_link").setAttribute("href", `../addFeed.html?url=${res.atom}`)
        ...
        if (res.rss) {
            document.getElementById("rss_link").setAttribute("href", `../addFeed.html?url=${res.rss}`)
